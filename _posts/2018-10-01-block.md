...
The game is very simple. The purpose is to avoid the green obstacles by either jumping or ducking over them. As you progress in score, the game speeds up. If you hit an obstacle, the game is over and the number of obstacles avoided is your final score.
